...
function calculateWealth(billionaire) 
{
    ...
    if (!wealth) 
    { // otherwise, calculate it (eg. lookups of external data or expensive calculations)
...
console.log(cachedWealth.get(billionaires[1]))
console.log(cachedWealth.get(billionaires[2]))